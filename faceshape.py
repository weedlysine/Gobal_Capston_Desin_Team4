...
#load the image
#imagepath = "'/Users/aminamaiga/Downloads/a.JPG"
#haarcascade for detecting faces
# link = https://github.com/opencv/opencv/tree/master/data/haarcascades
#face_cascade_path = open(''/Users/aminamaiga/Downloads/haarcascade_frontalface_default.xml')
#.dat file for detecting facial landmarks
#download file path = http://dlib.net/files/shape_predictor_68_face_landmarks.dat.bz2
#predictor_path = "'/Users/aminamaiga/Downloads/shape_predictor_68_face_landmarks.dat"

#create the haar cascade for detecting face and smile
faceCascade = cv2.CascadeClassifier('/Users/aminamaiga/Downloads/haarcascade_frontalface_default.xml')

#create the landmark predictor
predictor = dlib.shape_predictor('/Users/aminamaiga/Downloads/shape_predictor_68_face_landmarks.dat')

#read the image
image = cv2.imread('/Users/aminamaiga/Downloads/abc.JPG')
